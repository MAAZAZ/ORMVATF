            ...
            <div class="container">
                <div class="row mb-5">
                    <div class="col-md-12 mb-5">
                        <h3>Production animales</h3>
                            <table id="tableau">
                                <tr>
                                    <th colspan="2">Effectifs</th>
                                    <th colspan="2">Production moyenne (Tonnes)</th>
                                </tr>
                                <tr>
                                    <td>Ovins</td>
                                    <td>500.000</td>
                        ...
                        <p class="texte">La valeur moyenne des productions animales s’élève à 400 MDh pour une année à pluviométrie normale</p>
                    </div>
                </div>
            </div>
        </div>
