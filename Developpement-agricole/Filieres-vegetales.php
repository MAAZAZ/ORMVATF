            ...
            <div class="container">
                <div class="row mb-5">
                    <div class="col-md-12 mb-5">
                        <h3>Production végétales</h3>
                        <ul>
                            <li class="texte" style="color: black">Arboriculture</li>
                            <table id="tableau">
                                <tr>
                                    <th>Spéculations</th>
                                    <th>Nombre de pieds</th>
                                    <th>Production moyenne (Tonnes)</th>
                                </tr>
                                <tr>
                            ...
                            <li class="texte" style="color: black">Cultures basses</li>
                            <table id="tableau">
                                <tr>
                                    <th>Spéculations</th>
                                    <th>Nombre de pieds</th>
                        ...
                        <p class="texte">La valeur moyenne des productions végétales s’élève à 800 MDh pour une année à pluviométrie normale</p>
                    </div>
                </div>
            </div>
        </div>
