...
<head>
   ...
   <style>
        ...
        .image_doc{
            width: 70%;
            height: 70%;
            border-radius: 120px 80px 200px 200px;
            background-color: white;
        }
        #utiles{
            height: 60px;
            ...
            <div class="container">
                ...
                <div class="row no-gutters">
                    <div class="col-md-auto center-block">
                        ...
                        <a href="Documentation/Depliants+Brochures.php"><img class="image_doc" src="images/doc_depl.png"></a>
                    </div>
                    <div class="col-md-auto center-block">
                        <p>FICHES TECHNIQUES</p>
                        <a href="Documentation/Fiches+Techniques.php"><img class="image_doc" src="images/doc_fich.png"></a>
                    </div>
                    <div class="col-md-auto center-block">
                        <p>RAPPORTS</p>
                        <a href="Documentation/Rapports.php"><img class="image_doc" src="images/doc_rapp.png"></a>
                    </div>
                    <div class="col-md-auto center-block">
                        <p>TEXTES DE LOIS</p>
                        <a href="Documentation/Textes+de+Lois.php"><img class="image_doc" src="images/doc_lois.png"></a>
                    </div>
