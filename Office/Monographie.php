    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a href="../Médiatèque.html" class="nav-link">
        ...
        <ul class="navbar-nav  w-100 justify-content-center px-3">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <a class="dropdown-item" href="Mot_du_Directeur.php">Mot de directeur</a>
                    <a class="dropdown-item" href="Missions.php">Missions</a>
                    <a class="dropdown-item" href="Monographie.php">Monographie</a>
                    <a class="dropdown-item" href="Organigramme.php">Organigramme</a>
                </div>
            </li>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="../Developpement-agricole/Campagne-agricole.php">Compagne agricole</a>
            ...
            <div class="container">
                <div class="row mb-5">
                    <div class="col-md-12 mb-5">
                        ...
                        <p class="texte">Sur une superficie de 60.000 ha (0,8% de la superficie totale), le secteur agricole occupe une place économique et sociale importante dans la zone. En effet, l’agriculture demeure la principale activité économique dans le Tafilalet (90%), pour une population d’environ 600.000 habitants, dont 71% sont des ruraux.</p>
                        <ol>
                            <li class="texte">MILIEU PHYSIQUE</li>
                            ...
                            <table id="tableau">
                                ...
                                <ul>
                                    <tr>
                                        <td class="element">Superficie irriguée</td>
                                        <td class="element">60.000 ha (0,8%)</td>
                                    </tr>
                                    <tr>
                                        <td class="element">Superficie forestière</td>
                                        <td class="element">115.000 ha (1,5%)</td>
                                    </tr>
                                    <tr>
                                        <td class="element">Parcours</td>
                                        <td class="element">3.500.000 ha (45,3 %)</td>
                                    </tr>
                                    <tr>
                                        <td class="element">Terrains incultes</td>
                                        <td class="element">4.000.000 ha (52,4 %)</td>
                                    </tr>
                                    <tr>
                                        <td>Pluviométrie</td>
                                        <td>60 à 250 mm</td>
                            ...
                            <hr>
                            <li class="texte">SYSTEMES DE PRODUCTION</li>
                            <p class="text"><span style="font-weight: bold"> Zone de montagne : </span> Ce système de culture comprend deux étages : les rosacées fruitières (pommiers, poiriers et cognassiers) et les cultures basses (céréales, luzerne et cultures maraîchères) associées à l’élevage bovin et ovin extensif. Il est spécifique au Haut Ziz, Haut Guir et Haut Ghéris. </p>
                            <p class="text"><span style="font-weight: bold"> Zone intermédiaire : </span> 	Ce système de culture comprend trois étages à savoir : le palmier, l’olivier et les cultures sous-jacentes (céréales, luzerne, légumineuses et maraîchage). Ce Système est pratiqué au niveau des vallées moyennes du Ziz, Ghéris et Guir. </p>
                            <p class="text"><span style="font-weight: bold"> Zone de plaine : </span> La plaine se caractérise par un système de culture à deux étages : le palmier dattier et les cultures sous-jacentes (céréales, luzerne et henné) associées à l’élevage ovin intensif de race D’man. Ce système est conduit au niveau de la plaine du Tafilalet, au bas Ghéris et bas Todgha. </p>
                            <hr>
                            <li class="texte">RESSOURCES EN EAU</li>
                            <ul>
                                <li class="texte">Eaux superficielles</li>
                                <table id="tableau">
                                    <tr>
                                        <th>Bassin versant</th>
                                        <th>Apports moyens annuels (Mm<sup>3</sup>)</th>
                                        <th>Niveau de mobilisation</th>
                                    </tr>
                                    <tr>
                                        <td>ZIZ</td>
                                        <td>223</td>
                                ...
                                <li class="texte">Eaux souterraines (200 Mm<sup>3</sup>) </li>
                                <ul>
                                    <li class="texte">6.500 puits privés équipés;</li>
                                    <li class="texte">75 Stations collectives de pompage créées par l’Office;</li>
                                    <li class="texte">570 Khettaras dont 250 fonctionnelles.</li>
                                </ul>
                            </ul>
                        </ol>
