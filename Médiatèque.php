...
<div class="site-section">
    ...
    <div class="featured-donate overlay-color" style="background-image: url('images/plan.jpg');">
        <div class="site-section">
            <div class="container">
                ...
                <div class="row no-gutters">
                    <div class="col-md-4">
                        <a href="images/1.jpg" class="image-popup img-hover">
                            <span class="icon icon-search"></span>
                            <img src="images/1.jpg" alt="Image placeholder" class="img-fluid">
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="images/2.jpg" class="image-popup img-hover">
                            <span class="icon icon-search"></span>
                            <img src="images/2.jpg" alt="Image placeholder" class="img-fluid">
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="images/3.jpg" class="image-popup img-hover">
                            <span class="icon icon-search"></span>
                            <img src="images/3.jpg" alt="Image placeholder" class="img-fluid">
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="images/4.jpg" class="image-popup img-hover">
                            <span class="icon icon-search"></span>
                    ...
                    <div class="col-md-4">
                        <a href="images/5.jpg" class="image-popup img-hover">
                            <span class="icon icon-search"></span>
                            <img src="images/5.jpg" alt="Image placeholder" class="img-fluid">
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="images/6.jpg" class="image-popup img-hover">
                            <span class="icon icon-search"></span>
                            <img src="images/6.jpg" alt="Image placeholder" class="img-fluid">
                        </a>
                    </div>

                    <div class="col-md-4">
                        <a href="images/7.jpg" class="image-popup img-hover">
                            <span class="icon icon-search"></span>
                            <img src="images/7.jpg" alt="Image placeholder" class="img-fluid">
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="images/8.jpg" class="image-popup img-hover">
                            <span class="icon icon-search"></span>
                            <img src="images/8.jpg" alt="Image placeholder" class="img-fluid">
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="images/9.jpg" class="image-popup img-hover">
                            <span class="icon icon-search"></span>
                            <img src="images/9.jpg" alt="Image placeholder" class="img-fluid">
                        </a>
                    </div>
                    <div class="col-md-4 center-block">
                        <a href="images/10.jpg" class="image-popup img-hover">
                            <span class="icon icon-search"></span>
                            <img src="images/10.jpg" alt="Image placeholder" class="img-fluid">
                        </a>
                    </div>
    ...
    <div class="site-section">
        <div class="container">
            <div class="row text-center">
                <div class="col-md-4">
                    <iframe width="320" height="240" src="https://www.youtube.com/embed/7ScfgBbD6fg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                <div class="col-md-4">
                    <iframe width="320" height="240" src="https://www.youtube.com/embed/GkJeBlrmGXw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                <div class="col-md-4">
                    <iframe width="320" height="240" src="https://www.youtube.com/embed/GoatDfQTa0M" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
    ...
    <!-- changer les images dans le carousel -->
