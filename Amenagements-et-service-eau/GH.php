    ...
    <div class="collapse navbar-collapse flex-column " id="navbar">
        ...
        <ul class="navbar-nav  w-100 justify-content-center px-3">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <a class="dropdown-item" href="Pistes.php">Pistes</a>
                    <a class="dropdown-item" href="PMH.php">PMH</a>
                    <a class="dropdown-item" href="Systeme-irrigation-localisee.php">Système d'irrigation localisée</a>
                    <a class="dropdown-item" href="GH.php">GH</a>
                    <a class="dropdown-item" href="Etudes.php">Etudes</a>
                </div>
            </li>
